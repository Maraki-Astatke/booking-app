...
//   // Get my destinations (all for now)
...
//           {/* Welcome Banner */}
//           <div className="mb-8 p-6  rounded-2xl dark:text-white text-black relative overflow-hidden shadow-lg">
...
//               <p className="text-black-100 mt-1">Manage your destinations and monitor platform activity</p>
//             </div>
//           </div>

//           {/* 4 Stats Cards - Grey Colors */}
...
//           {/* Left Column - Bookings and Favorites */}
//           <div className="lg:col-span-2 space-y-8">
//             {/* Booked Trips Card - White/Gray */}
//             <div className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-200 dark:border-slate-800 shadow-lg overflow-hidden">
...
//           {/* Right Column - Travel Tips, Events */}
//           <div className="space-y-6">
//             {/* Travel Tips - White/Gray */}
//             <div className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-200 dark:border-slate-800 shadow-lg overflow-hidden">
//               <div className="border-b border-gray-200 dark:border-slate-800 px-6 py-4">
//                 <div className="flex items-center gap-2">
//                   <span className="text-xl">💡</span>
